 ...
 */
public class CourtInfo_ImageFocus extends FragmentActivity {
    static String ImageUrl1="";
    static String ImageUrl2="";
    static String ImageUrl3="";
    static String Choice="";
        private CourtInfo_ImageFocus.SectionsPagerAdapter mSectionsPagerAdapter;
        ...
        protected void onCreate(Bundle savedInstanceState) {
          ...
          //  Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
            ...
            Log.i("Choice",Choice);
            mSectionsPagerAdapter = new CourtInfo_ImageFocus.SectionsPagerAdapter(getSupportFragmentManager());
